...
const projectPrompts = [
    {
        ...
        choices: [
            { title: '1.0-SNAPSHOT', value: '1.0-SNAPSHOT' }
        ]
    },
    {
        type: 'select',
    ...
    },
    {
        ...
        choices: [
          ...
          { title: 'Native image', value: 'native' }
        ],
        initial: 0
    },
    {
...
const extensionsPromps = [
    {
        ...
        choices: [
          { title: 'JWT (include OAuth and OIDC support)', value: 'jwt' },
...
async function promptDal() {
    ...
    if (dal.inMemory) {
        ...
        let dal = await prompts(dalPrompts);
...
async function promptSpecsAndGenerate(projectName) {
    ...
    specs.project = await prompts(projectPrompts);
